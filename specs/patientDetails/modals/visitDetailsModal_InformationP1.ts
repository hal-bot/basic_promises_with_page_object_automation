...
//
// xdescribe('The Visit Details modal\'s "Visit Information" tab (from the Patient\'s Details page) P1 level tests ', () => {
//
...
//     it('should be showing the correct visit information fields', () => {
...
//         expect<any>(visitModal.visitInformationSection.mrNo).not.toBe('');
